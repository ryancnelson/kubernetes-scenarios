...
If this token doesn't work for you, it may have been reset:  retrieve the current one by running
...
this isn't big either

make sure you don't copy/paste any spaces from the end of the line, or linefeeds. This is problematic in GNU screen on some platforms.  You may have luck removing line-feeds and spaces, using a text editor.
